      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <nav className="container mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/auth/signin" className="text-gray-600 hover:text-black transition-colors hidden md:block">
              Sign In
            </Link>
            <Link 
              href="/auth/signup" 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/security" className="text-gray-600 hover:text-black transition-colors">Security</Link></li>
              </ul>
            </div>
          </div>
